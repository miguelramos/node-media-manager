...
/**
 * Function to stream file from ... to.
 * @param  {string}   src  Absolute path source
 * @param  {string}   dst  Absolute path destination
...
/**
 * Method to remove directories/files from home or is relative folders.
 *
...
/**
 * Method to copy file
 * @param  {string}   src Source relative path
 * @param  {string}   dst Destination relative path
 * @param  {Function} cb  Callback function
 * @return {void}
 */
...
/**
 * Method to move directory/file with relative paths to home.
 *
...
/**
 * Method to create directory/file simbolic link.
 *
 * @param  {string}   srcpath Source path relative
 * @param  {[type]}   dstpath Destination path relative
 * @param  {Function} cb      Callback function
 * @return {void}
 */
